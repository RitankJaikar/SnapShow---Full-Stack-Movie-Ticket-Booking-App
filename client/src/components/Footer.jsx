  ...
  return (
    <footer className="px-6 mt-40 md:px-16 lg:px-36 w-full text-gray-300">
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-14">
        <div className="md:max-w-96">
          ...
          <p className="mt-6 text-sm">
            SnapShow is a modern movie ticket booking platform that makes it easy to discover films, check showtimes, and reserve seats at nearby theaters. Designed for a smooth and simple experience, it helps you plan your movie night in just few taps.
          </p>
      ...
      <p className="pt-4 text-center text-sm pb-5">
        Copyright {new Date().getFullYear()} © SnapShow. All Right Reserved.
      </p>
    </footer>
  )
}
